...
tenant.example.com,ADHost
apim.example.com,apiHost
```
...
```bash
python3 har_to_jmx.py login.har Widget Gadget
```

```bash
python3 har_to_jmx.py login.har Widget Gadget hosts.csv
```

```bash
python3 har_to_jmx.py login.har Widget Gadget hosts.csv --out-dir generated --verbose
```

```bash
python3 har_to_jmx.py login.har Widget Gadget --config gadget-config.json --out-dir generated
```
...
```bash
python3 build_scenario_jmx.py recent.har Widget Gadget Recent_Transmittions
```

```bash
python3 build_scenario_jmx.py recent.har Widget Gadget Recent_Transmittions --out-dir generated --verbose
```

```bash
python3 build_scenario_jmx.py recent.har Widget Gadget Recent_Transmittions --config gadget-config.json --out-dir generated
```
