...
```bash
python3 har_to_jmx.py login.har --var project=Widget --var product=Gadget hosts.csv
python3 build_scenario_jmx.py recording.har Recent_Transmittions --var project=Widget --var product=Gadget
```
